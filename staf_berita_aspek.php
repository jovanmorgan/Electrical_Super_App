            ...
            <div class="container">
                <div class="blog-content">
                    ...
                    <div class="row" id="tampilanBerita">
                        ...
                        if (!empty($cariData)) {
                            $query = "SELECT * FROM blog WHERE (kategory = 'aspek') AND (DATE_FORMAT(tanggal, '%d-%b-%Y') LIKE '%$cariData%' OR judul LIKE '%$cariData%' OR link LIKE '%$cariData%' OR teks LIKE '%$cariData%' OR gambar LIKE '%$cariData%') LIMIT $batas_data, $data_per_halaman";
                        } else {
                            $query = "SELECT * FROM blog WHERE kategory = 'aspek' LIMIT $batas_data, $data_per_halaman";
                        }
