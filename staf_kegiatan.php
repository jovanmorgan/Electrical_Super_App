    ...
    <body>
        ...
        <nav id="untuk_scrol_navbar">
            <div class="nav-bar">
                ...
                <span class="logo navLogo"><a class="han" href="staf_user.php"><img src="images/10.png" class="mt-2 gbr1"
                            alt="" width="170px"></a></span>
                <div class="menu">
                    <div class="logo-toggle">
                        <span class="logo mt-2"><a href="staf_user.php"><img src="images/10.png" alt="" class="gbr2"
                                    width="70%" style="position: relative; right: 70px;"></a></span>
                    ...
                    <div class="custom-form">
                        ...
                        <div class="form-row mt-2">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="0" class="form-control todo" id="jumlah_alat_baik"
                                        name="jumlah_alat_baik[]" placeholder="Jumlah Alat Yang Baik" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="0" id="jumlah_alat_rusak" class="form-control nama"
                                        name="jumlah_alat_rusak[]" placeholder="Masukan Jumlah Alat Rusak" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-2">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control tmk" id="tgl_kegagalan" name="tgl_kegagalan[]"
                                        placeholder="Jumlah Alat Yang Baik" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="kategory_kerusakan" class="form-control kk"
                                        name="kategory_kerusakan[]" placeholder="Masukan Kategory Kerusakan" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-2">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <div class="input-group">
                                        <span class="input-group-text bg-success text-white mma2"><i
                                                class="fas fa-exclamation-circle"></i></span>
                                        <textarea id="jenis_kegagalan" class="form-control jk" name="jenis_kegagalan[]"
                                            placeholder="Masukan Jenis Kegagalan Alat" aria-label="With textarea" rows="2"
                                            required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control penanganan" id="penanganan" name="penanganan[]"
                                            placeholder="Penanganan Untuk Alat Yang Rusak" aria-label="With textarea"
                        ...
                        <div class="form-row mt-2">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control tsp" id="tgl_perbaikan" name="tgl_perbaikan[]"
                                        placeholder="Tanggal Selesai Perbaikan Alat" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="lama_kegagalan" class="form-control lk" name="lama_kegagalan[]"
                                        placeholder="Masukan Lama Kerusakan (Jam)" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-2">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="0" class="form-control fk" id="frekuensi_kegagalan"
                                        name="frekuensi_kegagalan[]" placeholder="Frekuensi Kegagalan (Kali)" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="waktu_pemeliharaan" class="form-control wp"
                                        name="waktu_pemeliharaan[]" placeholder="Masukan Lama Waktu Pemeliharaan (Jam)"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-2">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <div class="input-group">
                                        <span class="input-group-text bg-success text-white mma2"><i class="far fa-comment"
                                                required></i></span>
                                        <textarea class="form-control keterangan" id="keterangan" name="keterangan[]"
                                            placeholder="Masukan Keterangan" aria-label="With textarea" rows="2"
                                            required></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="custom-file" style="overflow: hidden;">
                                        <input type="file" id="gambar1" class="form-control gambar" name="gambar[]"
                                            required>
            ...
            <div class="container kotak2">
                <div class="card p-4 mb-5">
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-6">
                            <button type="button" class="btn btn-success d-grid gap-2 col-12 mt-4 btn2"
                                onclick="addNewForm()">Tambah Data</button>
                        </div>
                        <div class="col-6">
                            <button type="button" class="add btn btn-primary d-grid gap-2 col-12 mt-4 btn2"
                                onclick="addData()">Simpan Data</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            let apiBulanJanuari =
                "https://script.google.com/macros/s/AKfycbzCvpIM2KTUcDwVW5PK6i3D78q523pMjOqq3iosZC3LKiUwJWGlLivV0ztolqNNhiJT1Q/exec"
            let apiBulanFebruari =
                "https://script.google.com/macros/s/AKfycbz2RHhZBJFGQ371BAm3vnWu5G7g6Ng7R5yYNg2WzFUbZp5FMN6ASGlO9SuKM0nhSxlLcg/exec"
            let apiBulanMaret =
                "https://script.google.com/macros/s/AKfycbygqMPi8zf-ELg-xfJBCCk1c4JKUhRh2PppZplamZ_ieZElD2rK9yrxuPfHWEMr5hWlPg/exec"
            let apiBulanApril =
                "https://script.google.com/macros/s/AKfycbzKg5-jAobuTr02QWeQ8IWhrsRFZUEChq4hxgJM7LMS7hWK8DJ3bUJfUEc7gLIplkEf/exec"
            let apiBulanMei =
                "https://script.google.com/macros/s/AKfycbwbcF-HDiGJcvhIlom6ZTKDEzxqOtKcmJbO74ggHUieKs1LB7DNC2XiWAEpeSIziGhE/exec"
            let apiBulanJuni =
                "https://script.google.com/macros/s/AKfycbz6WgjPwDLYUAAGuB5YX9qL4ZLFjz69jrbcDEVW5ywHluXhZ_wlY8dx6_hwU94Je2RGRw/exec"
            let apiBulanJuli =
                "https://script.google.com/macros/s/AKfycbxstAjzGYh7frlwq7IuCxKWbTbVqVp4QGz4RS3GmnNf3zg8v6Dnx9a4u4cnRxXF3GedmQ/exec"
            let apiBulanAgustus =
                "https://script.google.com/macros/s/AKfycbxoXqo4uLqSQblGeuNau5brPfXElykGIu8lLO4HpUpj_f4krXLuz8Bch3WDDahhsI0N/exec"
            let apiBulanSeptember =
                "https://script.google.com/macros/s/AKfycby-_sKZSrRcea35hhDIXkqxMASFwvYU58tZag_qmwiuXoVJmluEkExohrFiZYi3hfdG/exec"
            let apiBulanOktober =
                "https://script.google.com/macros/s/AKfycbz_V4_S_vysrNUi0nZg_DXvom6ryBROc_wtR0vrtRFEkZJx7eiT0mBQN53eKEEE-cTE/exec"
            let apiBulanNovember =
                "https://script.google.com/macros/s/AKfycbxtVbZujW1kljUyCqaYY7XbuTBJXtwhzNOkazGAADNm_Y-KTmmKCpMmYpE-M73oCJ_b/exec"
            let apiBulanDesember =
            ...
            function addData() {
                ...
                if (!validateInputs(todos) || !validateInputs(nama) || !validateInputs(tmk) || !validateInputs(jk) ||
                    ...
                    !validateInputs(fk) || !validateInputs(wp) || !validateInputs(keterangan) || !validateInputs(kode) || !
                    validateInputs(baris)) {
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="5000" data-aos-duration="2000">
                    <div class="col-md-12">
                        <div class="sectioner-header text-center white">
                            ...
                            <p class="white">Aplikasi ini didukung oleh Angkasa Pura dan Badan Usaha Milik Negara (BUMN),
                                memberikan keandalan dan kualitas terbaik.</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="section-content text-center">
                            <ul>
                                <li><a href="#"><img src="images/bumn.png" class="wow fadeInUp" data-wow-delay="0.4s" /></a>
                                </li>
                                <li><a href="#"><img src="images/angkasapura.png" class="wow fadeInUp"
