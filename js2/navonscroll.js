function hide_on_scroll(obj) {
  ...
  var originalHeight = nav_height;
  var navClasses = document.createElement('style');
  navClasses.type = 'text/css';
  navClasses.innerHTML =
    '.nav-scroll-up{height:' + originalHeight + 'px; -webkit-transform: translateY(-' + 78 + 'px);-ms-transform: translateY(-' + 78 + 'px);transform: translateY(-' + 80 + 'px);}' +
    '.nav-scroll-down{height: ' + nav_height + 'px; -webkit-transform: translateY(' + 78 + 'px);-ms-transform: translateY(' + 78 + 'px);transform: translateY(' + 80 + 'px);}' +
