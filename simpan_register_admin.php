...
<body>
        ...
        // Tentukan tabel yang akan digunakan berdasarkan "Status Registrasi"
        if ($status === 'admin') {
                $table = 'admin';
                $status_value = 'admin';
        } else if ($status === 'user') {
                $table = 'user';
                $status_value = 'user';
        } else if ($status === 'admin_utama') {
                $table = 'admin_utama';
                $status_value = 'admin_utama';
        } else {
        ...
        if (isset($table)) {
                ...
                $hasil = mysqli_query($koneksi, "INSERT INTO $table (username, password, nama_lengkap, email, jenis_kelamin, tanggal_lahir, alamat, hp, status) VALUES ('$username', '$password', '$nama_lengkap', '$email', '$jenis_kelamin', '$tanggal_lahir', '$alamat', '$hp', '$status_value')");
