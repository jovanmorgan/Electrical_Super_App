            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!--works start -->
                        <section id="works" class="works" style="margin-top: 5%; z-index: 9;">
                            <div class="container">
                                <div class="section-header kata1">
                                    <h2><?php echo $bagian2_judul; ?></h2>
                                    <p><?php echo $bagian2_teks; ?></p>
                                </div>
                                <div class="user-info">
                                    <span class="camera-icon1 pembatas2" data-bs-toggle="modal" data-bs-target="#editModalBagian2">
                                        <i class="fas fa-pencil-alt fa-lg"></i>
                                    </span>
                                </div>
                                <!--/.section-header-->
                                <div class="works-content kata2">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6">
                                            <div class="single-how-works">
                                                <div class="single-how-works-icon">
                                                    <i class="far fa-newspaper fa-3x" style="position: relative; top: 10px;"></i>
                                                </div>
                                                <h2><a href="admin_berita_terkini.php"><?php echo $icon1_judul; ?></a></h2>
                                                <p>
                                                    <?php echo $icon1_teks; ?>
                                                </p>
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="single-how-works">
                                                <div class="single-how-works-icon">
                                                    <i class="far fa-lightbulb fa-3x" style="position: relative; top: 10px;"></i>
                                                </div>
                                                <h2><a href="admin_berita_inovasi.php"> <?php echo $icon2_judul; ?></a></h2>
                                                <p>
                                                    <?php echo $icon2_teks; ?>
                                                </p>
                                                <!-- <button class="welcome-hero-btn how-work-btn" onclick="window.location.href='#'">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="single-how-works">
                                                <div class="single-how-works-icon">
                                                    <i class="fas fa-plug fa-3x" style="position: relative; top: 10px;"></i>
                                                </div>
                                                <h2><a href="admin_berita_aspek.php"><?php echo $icon3_judul; ?></a></h2>
                                                <p>
                                                    <?php echo $icon3_teks; ?>
                                                </p>
                                                <!-- <button class="welcome-hero-btn how-work-btn" onclick="window.location.href='#'">
                                ...
                                <div class="user-info">
                                    <span class="camera-icon1 pembatas3" data-bs-toggle="modal" data-bs-target="#editModalBagian3">
                                        <i class="fas fa-pencil-alt fa-lg"></i>
                                    </span>
                                </div>
                            </div>
                        ...
                        <script>
                            ...
                            function editBagian3() {
                                // Retrieve values from the modal
                                const idBerita = document.getElementById('id_berita').value;
                                const icon1Judul = document.getElementById('icon1_judul').value;
                                const icon1Teks = document.getElementById('icon1_teks').value;
                                const icon2Judul = document.getElementById('icon2_judul').value;
                                const icon2Teks = document.getElementById('icon2_teks').value;
                                const icon3Judul = document.getElementById('icon3_judul').value;
                                const icon3Teks = document.getElementById('icon3_teks').value;
                                ...
                                const formData = new FormData();
                                formData.append('idBerita', idBerita);
                                formData.append('icon1Judul', icon1Judul);
                                formData.append('icon1Teks', icon1Teks);
                                formData.append('icon2Judul', icon2Judul);
                                formData.append('icon2Teks', icon2Teks);
                                formData.append('icon3Judul', icon3Judul);
                                formData.append('icon3Teks', icon3Teks);

                                $.ajax({
                                    url: "proses_edit_konten3.php",
                                    type: "POST",
                                    data: formData,
                                    contentType: false,
                                    processData: false,
                                        ...
                                        <div class="modal-body center-block">
                                            ...
                                            <div class="form-row mt-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" id="teks" name="teks" placeholder="Silakan Isi Teks Konten" aria-label="With textarea" rows="2" required></textarea>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                        ...
                        <!-- Elemen modal -->
                        <div id="editModalBagian2" class="modal">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Konten 2</h5>
                                        <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                                    </div>
                                    <form enctype="multipart/form-data">
                                        <input type="hidden" id="id_berita" class="form-control" value="<?php echo $id_berita; ?>" name="id_berita" placeholder="id Berita" required>
                                        <div class="modal-body center-block">
                                            <div class="form-row mt-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="<?php echo $bagian2_judul; ?>" id="bagian2_judul" class="form-control" name="bagian2_judul" placeholder="Judul Konten" required>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                                                <label for="bagian1_teks">Teks Konten :</label><br>
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" id="bagian2_teks" name="bagian2_teks" placeholder="Silakan Isi Teks Konten" aria-label="With textarea" rows="2" required><?php echo $bagian2_teks; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" id="btnEditBagian2" onclick="editBagian2()">Edit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <!-- Elemen modal -->
                        <div id="editModalBagian3" class="modal">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Konten 2</h5>
                                    ...
                                    <form enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body center-block">
                                            <div class="form-row mt-2">
                                                <label for="bagian1_judul">Judul Icon Ke 1 :</label><br>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-success text-white h-100" id="basic-addon1"><i class="fas fa-link"></i></span>
                                                    </div>
                                                    <input type="text" value="<?php echo $icon1_judul; ?>" id="icon1_judul" class="form-control" name="icon1_judul" placeholder="Judul Konten" required>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                                                <label for="bagian1_teks">Teks Icon Ke 1 :</label><br>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-success text-white h-100" id="basic-addon1"><i class="fas fa-file-alt"></i></span>
                                                    </div>
                                                    <textarea class="form-control" id="icon1_teks" name="icon1_teks" placeholder="Silakan Isi Teks Konten" aria-label="With textarea" rows="2" required><?php echo $icon1_teks; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                                                <label for="bagian1_judul">Judul Icon Ke 2 :</label><br>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-success text-white h-100" id="basic-addon1"><i class="fas fa-link"></i></span>
                                                    </div>
                                                    <input type="text" value="<?php echo $icon2_judul; ?>" id="icon2_judul" class="form-control" name="icon2_judul" placeholder="Judul Konten" required>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                                                <label for="bagian1_teks">Teks Icon Ke 2 :</label><br>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-success text-white h-100" id="basic-addon1"><i class="fas fa-file-alt"></i></span>
                                                    </div>
                                                    <textarea class="form-control" id="icon2_teks" name="icon2_teks" placeholder="Silakan Isi Teks Konten" aria-label="With textarea" rows="2" required><?php echo $icon2_teks; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                                                <label for="bagian3_judul">Judul Icon Ke 3 :</label><br>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-success text-white h-100" id="basic-addon1"><i class="fas fa-link"></i></span>
                                                    </div>
                                                    <input type="text" value="<?php echo $icon3_judul; ?>" id="icon3_judul" class="form-control" name="icon3_judul" placeholder="Judul Konten" required>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                                                <label for="bagian3_teks">Teks Icon Ke 3 :</label><br>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-success text-white h-100" id="basic-addon1"><i class="fas fa-file-alt"></i></span>
                                                    </div>
                                                    <textarea class="form-control" id="icon3_teks" name="icon3_teks" placeholder="Silakan Isi Teks Konten" aria-label="With textarea" rows="2" required><?php echo $icon3_teks; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" id="btnEditBagian3" onclick="editBagian3()">Edit</button>
                                        </div>
                                    </form>
                                        ...
                                        <div class="modal-body center-block">
                                            ...
                                            <div class="form-row mt-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" id="edit_teks" name="edit_teks" placeholder="Silakan Isi Teks Konten" aria-label="With textarea" rows="2" required></textarea>
                                                </div>
                                            </div>
                                            <div class="form-row mt-2">
                                                <label for="gambar">Gambar Berita :</label><br>
                        ...
                        <!-- Elemen modal -->
                        <div id="editbagian1" class="modal">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Berita</h5>
                                    ...
                                    <form enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" id="editBagian1" onclick="editBagian1()">Edit</button>
                                        </div>
                                    </form>
                            ...
                            <div class="container">
                                <div class="blog-content">
                                    ...
                                    <div class="row" id="tampilanBerita">
                                        ...
                                        if (!empty($cariData)) {
                                            $query = "SELECT * FROM blog WHERE kategory LIKE '%$cariData%' OR link LIKE '%$cariData%' OR judul LIKE '%$cariData%' OR DATE_FORMAT(tanggal, '%d-%b-%Y') LIKE '%$cariData%' OR teks LIKE '%$cariData%' OR gambar LIKE '%$cariData%' LIMIT $batas_data, $data_per_halaman";
                                        } else {
                                            $query = "SELECT * FROM blog LIMIT $batas_data, $data_per_halaman";
                                        }
