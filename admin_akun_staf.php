    ...
    <body>
        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $id_users = mysqli_query($koneksi, $query);
                ...
                while ($row = mysqli_fetch_assoc($id_users)) {
                    $id = $row['id_user'];
                ...
                foreach ($updatedCheckboxStatus as $id => $status) {
                    $updateQuery = "UPDATE user SET status_akun='$status' WHERE id_user='$id'";
            ...
            if (!empty($cariData)) {
                $query = "SELECT * FROM user WHERE username LIKE '%$cariData%' OR password LIKE '%$cariData%' OR nama_lengkap LIKE '%$cariData%' OR email LIKE '%$cariData%' OR jenis_kelamin LIKE '%$cariData%' OR tanggal_lahir LIKE '%$cariData%' OR alamat LIKE '%$cariData%' OR hp LIKE '%$cariData%' LIMIT $batas_data, $data_per_halaman";
            } else {
                $query = "SELECT * FROM user LIMIT $batas_data, $data_per_halaman";
            }
            ...
            <div class="page-wrapper">
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title text-center">Tabel Staf</h1>
                        <hr>
                                ...
                                <table id="" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $checkboxName = "checkbox_" . $row['id_user']; // Gunakan id_user sebagai bagian dari nama input checkbox
                                            ...
                                            echo "</td>";
                                            echo "<td>" . $no . "</td>";
                                            echo "<td>" . $row["username"] . "</td>"; // Menampilkan kolom "username" sebagai pengganti "id_user"
