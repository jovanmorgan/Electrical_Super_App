                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6">
                                            <div class="single-how-works">
                                                ...
                                                <h2><a href="manager_berita_terkini.php"><?php echo $icon1_judul; ?></a></h2>
                                                <p>
                                                    <?php echo $icon1_teks; ?>
                                                </p>
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="single-how-works">
                                                ...
                                                <h2><a href="manager_berita_inovasi.php"> <?php echo $icon2_judul; ?></a></h2>
                                                <p>
                                                    <?php echo $icon2_teks; ?>
                                                </p>
                                                <!-- <button class="welcome-hero-btn how-work-btn" onclick="window.location.href='#'">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="single-how-works">
                                                ...
                                                <h2><a href="manager_berita_aspek.php"><?php echo $icon3_judul; ?></a></h2>
                                                <p>
                                                    <?php echo $icon3_teks; ?>
                                                </p>
                                                <!-- <button class="welcome-hero-btn how-work-btn" onclick="window.location.href='#'">
